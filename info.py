...
STREAM_BIN = environ.get("STREAM_BIN", "-1002112850061") #Log channel/Bin Channel id -100xxxxxxx
STREAM_URL = environ.get("STREAM_URL", "https://useful-maure-monitg.koyeb.app/") # https://example.com/ (Your Stream Url)
